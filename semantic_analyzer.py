...
class SemanticAnalyzer:
    def __init__(self) -> None:
        ...
        self.semantic_check_actions = {
              ...
              '@ass_func_role': self.assign_function_role,
              '@ass_var_role': self.assign_var_role,
              '@assign_len': self.assign_length,
              '@inc_scope': self.increase_scope,
              '@ass_fun_attrs': self.assign_func_attrs,
